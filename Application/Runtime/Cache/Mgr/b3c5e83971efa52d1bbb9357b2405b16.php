...
<div class="main">
	...
	<table class="main_list" cellpadding="0" cellspacing="0" width="100%">
		<tr class="head"><td width="140">手册名称</td><td width="80">所属频道</td><td width="60">负责人</td>
		<td width="60">章</td><td width="60">节</td><td>简介</td>
		<td width="140" align="center"><a href="handbooks_add" class="btn1 btn_blue1">
		<i class="icon-plus-sign"></i> 新增</a></td></tr>
		<tr class="body"><td class="bg_blue1 green1">Java常用类</td><td>Java基础</td><td>崔鹏宇</td>
		<td><a href="handbooks_section1" class="tbl_a1">4章</a></td>
		<td><a href="handbooks_section2" class="tbl_a1">64节</td>
