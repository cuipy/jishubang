...
<div class="bx_head">
	...
	<div class="fr">
		...
		<div class="btn_head" onclick="href('/jishubang/index.php/mgr/wenzhang')">文章</div>
...
<div class="box_left">
	<ul >
		<li class="title" onclick="href('/jishubang/index.php/mgr/wenzhang')"><i class="ico icon-cog"></i><span class="txt">文章</span></li>
		<li class="menu" id="sort_list" onclick="href('/jishubang/index.php/mgr/wenzhang/sort_list')"><i class="ico icon-sitemap"></i> <span class="txt">文章分类</span></li>
