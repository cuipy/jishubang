...
<div class="main">
	<table class="tbl_form" cellpadding="0" cellspacing="0" width="98%">
		<tr>
			<td colspan="3" class="head">增加一节</td></tr>
		<tr>
		...
		<tr>
			<td class="title" width="140" height="40">章标题：</td>
			<td width="200">JAVA基础语法</td>
			<td class="info">&nbsp;</td>
		</tr>
		<tr>
			<td class="title" width="140" height="40">节标题：</td>
			<td width="200"><input type="text" class="textbox1" placeholder="请填写节标题"></td>
			<td class="info">&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2">
				...
				<button class="btn2 btn_green1">保存并维护内容</button>&nbsp;&nbsp;&nbsp;&nbsp;
